...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="username" name="username" placeholder="Escolha seu nome" required />
            </div>
            ...
            <Button disabled={loading} className="w-full h-12 text-base" type="submit">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">Já possui um treinador?</p>
            <button type="button" onClick={() => router.push('/autenticate/login')} className="mt-2 font-semibold text-primary hover:underline transition">
              Voltar para login
            </button>
          </div>
        </div>
      ...
      {/* HERO */}
      <div
        className="hidden lg:flex items-center justify-center overflow-hidden px-16 text-primary-foreground bg-gradient-to-br from-primary to-primary/70">
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg text-primary-foreground/80">
            Escolha seu nome, monte sua equipe
            e explore uma região cheia de desafios,
            descobertas e criaturas únicas.
          </p>
