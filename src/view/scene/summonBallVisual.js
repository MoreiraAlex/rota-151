/**
 * Aparência da `SummonBall` (ver docs/features/024-esfera-de-invocar.md,
 * `SummonBallView.jsx`) — maior e mais colorida que a esfera cinza
 * genérica de `throwableVisual.js`, pra ficar claramente distinguível em
